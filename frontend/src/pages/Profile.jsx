...
class Profile extends React.Component {
    ...
    render() {
        return(
            <>
                <main className="profile-page md:mt-12 pb-12">
                                    ...
                                    <div className="text-center mt-12 mb-2">
                                        <div className={"justify-center mx-auto w-max flex gap-x-4"}>
                                            <div className={""}>
                                                <h3 className="text-2xl font-semibold leading-normal mb-2 text-gray-800 mb-2">
                                                    {this.state && this.state.profile['firstname'] + " " + this.state.profile['lastname']}
                                                </h3>
                                        ...
                                        <div className="text-sm leading-normal mt-6 mb-2 text-gray-800 font-medium uppercase">
                                            ...
                                            <a className={'text-gray-400'}>
                                                {this.state && this.state.profile['specialization']}
                                            </a>
                                        </div>
                                        <div className="text-sm leading-normal -mt-2 mb-4 text-gray-800 font-medium uppercase">
                                            ...
                                            <a className={'text-gray-400'}>
                                                <Moment format="DD/MM/YYYY">
                                                    {this.state && this.state.profile.birthday}
                                                </Moment>
                                            </a>
                                        </div>
