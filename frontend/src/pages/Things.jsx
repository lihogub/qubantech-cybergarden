...
export default function Things() {
    return (
        <>
            <main className="container mx-auto things-page">
                <section className="relative md:mt-10 block mb-2" style={{ height: "50px" }}>
                    <div className="absolute top-0 w-full h-full bg-gradient-to-b bg-gradient-to-b from-purple ...">
                        ...
                        <button type="button"
                                className="mt-4 mr-3 rounded-full h-12 w-11 py-2 px-4 bg-transparent hover:bg-purple-secondary-200 focus:ring-purple-secondary focus:ring-offset-purple-secondary
                ...
                <section className="relative py-4 mt-8 pb-12 mb-2 bg-white">
                        ...
                        <div className="relative flex flex-col w-full items-center justify-center">
                            <ul className="w-full">
                                <li className="border-gray-500 flex flex-col mb-10 gap-y-3 ">
                                    ...
                                    <div
                                        className="overflow-hidden shadow-lg rounded-lg h-90 w-full cursor-pointer m-auto my-2">
                                        <a href="#" className="w-full block h-full">
                                            <img alt="blog photo" src="http://fornax55.ru/image/catalog/bread_catalog/pshenich_1000.jpg"
